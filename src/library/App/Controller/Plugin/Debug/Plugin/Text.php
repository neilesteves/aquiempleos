 ...
 * @license    http://code.google.com/p/zfdebug/wiki/License     New BSD License
 */
class App_Controller_Plugin_Debug_Plugin_Text
    implements App_Controller_Plugin_Debug_Plugin_Interface
{
    ...
    /**
     * Create App_Controller_Plugin_Debug_Plugin_Text
     *
     * @param string $tab
     * @paran string $panel
     * @return void
     ...
     *
     * @param string $name
     * @return App_Controller_Plugin_Debug_Plugin_Text Provides a fluent interface
     */
