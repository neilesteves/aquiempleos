 ...
 * @license    http://code.google.com/p/zfdebug/wiki/License     New BSD License
 */
class App_Controller_Plugin_Debug_Plugin_Html extends App_Controller_Plugin_Debug_Plugin
    implements App_Controller_Plugin_Debug_Plugin_Interface
{
    ...
    /**
     * Create App_Controller_Plugin_Debug_Plugin_Html
     *
     * @param string $tab
     * @paran string $panel
     * @return void
    ...
    public function getPanel()
    {
        ...
        $panel .= $dom->getElementsByTagName('*')->length . ' Tags in ' . round(strlen($body) / 1024,
                2) . 'K' . $linebreak
