 ...
 * @license    http://code.google.com/p/zfdebug/wiki/License     New BSD License
 */
class App_Controller_Plugin_Debug_Plugin_Log extends Zend_Controller_Plugin_Abstract
    implements App_Controller_Plugin_Debug_Plugin_Interface
{
    ...
    public function __construct()
    {
        ...
        $this->_writer = new App_Controller_Plugin_Debug_Plugin_Log_Writer();
    ...
    public function getPanel()
    {
        ...
        $panel .= '<table cellpadding="0" cellspacing="0">' . implode('',
                $this->_writer->getMessages()) . '</table>';
        return $panel;
    }
