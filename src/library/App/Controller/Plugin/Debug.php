 ...
 * @license    http://code.google.com/p/zfdebug/wiki/License     New BSD License
 */
class App_Controller_Plugin_Debug extends Zend_Controller_Plugin_Abstract
{
    ...
    public function __construct($options = null)
    {
         ...
         */
        $version = new App_Controller_Plugin_Debug_Plugin_Text();
         ...
         */
        $logger = new App_Controller_Plugin_Debug_Plugin_Log();
     ...
     *
     * @param App_Controller_Plugin_Debug_Plugin_Interface
     * @return App_Controller_Plugin_Debug
     */
    public function registerPlugin(App_Controller_Plugin_Debug_Plugin_Interface $plugin)
    {
     ...
     * @return App_Controller_Plugin_Debug_Plugin_Interface
     */
    ...
    protected function _loadPlugins()
    {
        foreach ($this->_options['plugins'] as $plugin => $options) {
            ...
            if (is_object($plugin) && in_array('App_Controller_Plugin_Debug_Plugin_Interface',
            ...
            if (in_array($plugin,
                    App_Controller_Plugin_Debug::$standardPlugins)) {
                // standard plugin
                $pluginClass = 'App_Controller_Plugin_Debug_Plugin_' . $plugin;
            } else {
