<?php
class SolrClient_Query_QueryString
{
     ...
     * @return Querystring
     */
    public function addField(SolrClient_Query_Field $field, $key = null)
    {
        if ($key) {
     ...
     * @return Querystring
     */
    public function addSubQuery(SolrClient_Query_QueryString $query, $key = null)
    {
        if ($key) {
