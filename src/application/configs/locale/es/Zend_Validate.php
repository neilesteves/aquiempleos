...
return array(
	 ...
	 "Invalid type given, value should be a string" => "El tipo especificado no es válido, el valor debe ser una cadena de texto",
	 "'%value%' is no valid email address in the basic format local-part@hostname" => "'Correo invalido, el formato adecuado es: ejemplo@aquiempleos.com",
...
// Zend_Validate_GreaterThan
	 ...
	 "The two given tokens do not match" => "Las dos muestras especificadas no concuerdan",
	 "No token was provided to match against" => "No se ha especificado ninguna muestra a comprobar",

	 // Zend_Validate_InArray
	 //"'%value%' was not found in the haystack" => "No se ha encontrado '%value%' en la base de datos",
	 "'%value%' was not found in the haystack" => "Debe elegir una opción",
	 ...
	 "Captcha value is wrong" => "El valor en el captcha es erroneo",
