		...
		jQuery.fn.dateSelectBoxes = function(monthElem, dayElem, yearElem, keepLabels)
			{
				...
				function updateDays() {
                    ...
                    for(var item = 0; item < validDays.length; item++){
                        dayElem.addOption( validDays[item] ,validDays[item], false);
                    }
                    dayElem.selectOptions(selected[0]);
                    dayElem.removeOption(['copy','remove','inArray']);
				}
